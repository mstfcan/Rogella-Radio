class RadioFavorite{
  ...
  RadioFavorite(this._radio_id, this._stationuuid);

  RadioFavorite.withID(this._id, this._radio_id, this._stationuuid);
  ...
  RadioFavorite.fromMap(Map<String,dynamic> temp){
    this._id=temp["id"];
